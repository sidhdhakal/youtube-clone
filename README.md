...
```
cd existing_repo
git remote add origin https://gitlab.com/sidhdhakal/youtube-project.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/sidhdhakal/youtube-project/-/settings/integrations)
